...
from shoper.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from shoper.manufacturing.doctype.production_plan.production_plan import (
...
from shoper.stock.get_item_details import get_default_bom, get_price_list_rate
from shoper.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	def validate(self):
		...
		if self.coupon_code:
			from shoper.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from shoper.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from shoper.stock.doctype.packed_item.packed_item import is_product_bundle
