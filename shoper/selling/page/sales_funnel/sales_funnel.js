...
frappe.pages['sales-funnel'].on_page_load = function(wrapper) {
	...
	wrapper.sales_funnel = new shoper.SalesFunnel(wrapper);

	frappe.breadcrumbs.add("Selling");
}

shoper.SalesFunnel = class SalesFunnel {
	constructor(wrapper) {
		var me = this;
	...
	get_data(btn) {
		...
		const method_map = {
			"sales_funnel": "shoper.selling.page.sales_funnel.sales_funnel.get_funnel_data",
			"opp_by_lead_source": "shoper.selling.page.sales_funnel.sales_funnel.get_opp_by_lead_source",
			"sales_pipeline": "shoper.selling.page.sales_funnel.sales_funnel.get_pipeline_data"
		};
		frappe.call({
