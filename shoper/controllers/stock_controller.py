...
from shoper.accounts.utils import cancel_exchange_gain_loss_journal, get_fiscal_year
from shoper.controllers.accounts_controller import AccountsController
from shoper.stock import get_warehouse_account_map
from shoper.stock.doctype.inventory_dimension.inventory_dimension import (
	get_evaluated_inventory_dimension,
)
from shoper.stock.stock_ledger import get_items_to_be_repost
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		...
		if (
			cint(shoper.is_perpetual_inventory_enabled(self.company))
	...
	def clean_serial_nos(self):
		from shoper.stock.doctype.serial_no.serial_no import clean_serial_no_string
	...
	def make_sl_entries(self, sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
		from shoper.stock.stock_ledger import make_sl_entries
	...
	def validate_warehouse(self):
		from shoper.stock.utils import validate_disabled_warehouse, validate_warehouse_company
	...
	def validate_putaway_capacity(self):
		...
		from shoper.stock.doctype.putaway_rule.putaway_rule import get_available_putaway_capacity
