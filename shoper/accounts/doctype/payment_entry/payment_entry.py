...
import shoper
from shoper.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_party_bank_account,
)
from shoper.accounts.doctype.invoice_discounting.invoice_discounting import (
...
from shoper.accounts.general_ledger import make_gl_entries, process_gl_map
...
from shoper.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from shoper.accounts.doctype.payment_request.payment_request import update_payment_req_status
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = (
				"credit" if shoper.get_party_account_type(self.party_type) == "Receivable" else "debit"
			)
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or shoper.get_company_currency(
		ref_doc.company
	)
