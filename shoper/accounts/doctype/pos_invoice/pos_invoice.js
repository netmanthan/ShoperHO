...
shoper.selling.POSInvoiceController = class POSInvoiceController extends shoper.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new shoper.selling.POSInvoiceController({ frm: cur_frm }))
