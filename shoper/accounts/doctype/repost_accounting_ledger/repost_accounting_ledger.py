...
class RepostAccountingLedger(Document):
	...
	def generate_preview(self):
		from shoper.accounts.report.general_ledger.general_ledger import get_columns as get_gl_columns
		...
		rendered_page = frappe.render_template(
			"shoper/accounts/doctype/repost_accounting_ledger/repost_accounting_ledger.html",
	...
	def on_submit(self):
		...
		frappe.enqueue(
			method="shoper.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger.start_repost",
