frappe.provide("shoper.timesheet");

shoper.timesheet.timer = function(frm, row, timestamp=0) {
	...
	shoper.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

shoper.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
