...
frappe.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-shoper/articles/bulk-rename",
	},
];
...
frappe.help.help_links["List/Authorization Rule"] = [
	{
		...
		url: docsUrl + "user/manual/en/customize-shoper/authorization-rule",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-shoper/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-shoper/customize-form",
	},
];
