...
from shoper.crm.doctype.lead.lead import get_lead_with_phone_number
from shoper.crm.doctype.utils import get_scheduled_employees_for_popup, strip_number
