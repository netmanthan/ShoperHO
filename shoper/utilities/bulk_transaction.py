...
def task(doc_name, from_doctype, to_doctype):
	from shoper.accounts.doctype.payment_entry import payment_entry
	from shoper.accounts.doctype.purchase_invoice import purchase_invoice
	from shoper.accounts.doctype.sales_invoice import sales_invoice
	from shoper.buying.doctype.purchase_order import purchase_order
	from shoper.buying.doctype.supplier_quotation import supplier_quotation
	from shoper.selling.doctype.quotation import quotation
	from shoper.selling.doctype.sales_order import sales_order
	from shoper.stock.doctype.delivery_note import delivery_note
	from shoper.stock.doctype.purchase_receipt import purchase_receipt
