...
from shoper.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from shoper.stock.utils import add_additional_uom_columns
...
class StockBalanceReport(object):
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = shoper.get_company_currency(self.filters.get("company"))
		else:
