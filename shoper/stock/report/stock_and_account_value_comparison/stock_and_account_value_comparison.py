...
import shoper
from shoper.accounts.utils import get_currency_precision, get_stock_accounts
from shoper.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not shoper.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
