...
import shoperho
from shoperho.loan_management.report.applicant_wise_loan_security_exposure.applicant_wise_loan_security_exposure import (
...
def get_active_loan_details(filters):
	...
	currency = shoperho.get_company_currency(filters.get("company"))
