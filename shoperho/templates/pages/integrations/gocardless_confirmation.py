...
from shoperho.shoperho_integrations.doctype.gocardless_settings.gocardless_settings import (
...
def create_mandate(data):
	...
	if frappe.db.exists("GoCardless Mandate", mandate):
		...
		shoperho_customer = frappe.db.get_value(
			...
			frappe.get_doc(
				{
					...
					"mandate": mandate,
					"customer": shoperho_customer.customer_name,
