...
shoperho.maintenance.MaintenanceSchedule = class MaintenanceSchedule extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new shoperho.maintenance.MaintenanceSchedule({frm: cur_frm}));
