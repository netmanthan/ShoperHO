...
from shoperho.controllers.sales_and_purchase_return import get_rate_for_return
from shoperho.controllers.stock_controller import StockController
from shoperho.stock.doctype.item.item import set_item_default
from shoperho.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from shoperho.accounts.party import _get_party_details
			...
			from shoperho.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from shoperho.controllers.buying_controller import validate_item_type
