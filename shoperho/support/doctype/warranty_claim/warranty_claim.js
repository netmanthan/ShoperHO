...
frappe.provide("shoperho.support");
...
shoperho.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new shoperho.support.WarrantyClaim({frm: cur_frm}));
