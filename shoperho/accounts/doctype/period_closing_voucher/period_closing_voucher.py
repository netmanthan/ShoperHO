...
from shoperho.accounts.utils import get_account_currency, get_fiscal_year, validate_fiscal_year
...
def process_closing_entries(gl_entries, closing_entries, voucher_name, company, closing_date):
	from shoperho.accounts.doctype.account_closing_balance.account_closing_balance import (
...
def make_reverse_gl_entries(voucher_type, voucher_no):
	from shoperho.accounts.general_ledger import make_reverse_gl_entries
