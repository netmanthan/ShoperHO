...
shoperho.selling.POSInvoiceController = class POSInvoiceController extends shoperho.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new shoperho.selling.POSInvoiceController({ frm: cur_frm }))
