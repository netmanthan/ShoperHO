...
shoperho.taxes_and_totals = class TaxesAndTotals extends shoperho.payments {
	setup() {
	...
	fetch_round_off_accounts() {
		...
		if (me.frm.doc.company) {
			return frappe.call({
				"method": "shoperho.controllers.taxes_and_totals.get_round_off_applicable_accounts",
				"args": {
