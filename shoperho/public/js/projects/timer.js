frappe.provide("shoperho.timesheet");

shoperho.timesheet.timer = function(frm, row, timestamp=0) {
	...
	shoperho.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

shoperho.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
