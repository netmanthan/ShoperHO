...
frappe.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-shoperho/articles/bulk-rename",
	},
];
...
frappe.help.help_links["Form/PayPal Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/shoperho_integration/paypal-integration",
	},
];
...
frappe.help.help_links["Form/Razorpay Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/shoperho_integration/razorpay-integration",
	},
];
...
frappe.help.help_links["Form/Dropbox Settings"] = [
	{
		...
		url: docsUrl + "user/manual/en/shoperho_integration/dropbox-backup",
	},
];
...
frappe.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
		url:
			docsUrl + "user/manual/en/shoperho_integration/ldap-integration",
	},
];
...
frappe.help.help_links["Form/Stripe Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/shoperho_integration/stripe-integration",
	},
];
...
frappe.help.help_links["List/Authorization Rule"] = [
	{
		...
		url: docsUrl + "user/manual/en/customize-shoperho/authorization-rule",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-shoperho/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-shoperho/customize-form",
	},
];
