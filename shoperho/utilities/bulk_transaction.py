...
def task(doc_name, from_doctype, to_doctype):
	from shoperho.accounts.doctype.payment_entry import payment_entry
	from shoperho.accounts.doctype.purchase_invoice import purchase_invoice
	from shoperho.accounts.doctype.sales_invoice import sales_invoice
	from shoperho.buying.doctype.purchase_order import purchase_order
	from shoperho.buying.doctype.supplier_quotation import supplier_quotation
	from shoperho.selling.doctype.quotation import quotation
	from shoperho.selling.doctype.sales_order import sales_order
	from shoperho.stock.doctype.delivery_note import delivery_note
	from shoperho.stock.doctype.purchase_receipt import purchase_receipt
