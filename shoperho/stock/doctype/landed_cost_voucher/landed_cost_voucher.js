...
shoperho.stock.LandedCostVoucher = class LandedCostVoucher extends shoperho.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(shoperho.stock.LandedCostVoucher);
