frappe.listview_settings['Quotation'] = {
	...
	onload: function(listview) {
		...
		listview.page.add_action_item(__("Sales Order"), ()=>{
			shoperho.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
		});

		listview.page.add_action_item(__("Sales Invoice"), ()=>{
			shoperho.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
		});
	},
