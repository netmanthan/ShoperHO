...
shoperho.selling.QuotationController = class QuotationController extends shoperho.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "shoperho.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(shoperho.selling.QuotationController);
