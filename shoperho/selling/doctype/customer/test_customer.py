...
from shoperho.accounts.party import get_due_date
from shoperho.exceptions import PartyDisabled, PartyFrozen
from shoperho.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
from shoperho.tests.utils import create_test_contact_and_address
...
class TestCustomer(FrappeTestCase):
	...
	def test_party_details(self):
		from shoperho.accounts.party import get_party_details
	...
	def test_serach_fields_for_customer(self):
		from shoperho.controllers.queries import customer_query
