...
shoperprimeho.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new shoperprimeho.accounts.NumberCard(summary);
...
shoperprimeho.accounts.NumberCard = class NumberCard {
	constructor(options) {
