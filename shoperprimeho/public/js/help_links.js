...
frappe.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-shoperprimeho/articles/bulk-rename",
	},
];
...
frappe.help.help_links["List/Authorization Rule"] = [
	{
		...
		url: docsUrl + "user/manual/en/customize-shoperprimeho/authorization-rule",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-shoperprimeho/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-shoperprimeho/customize-form",
	},
];
