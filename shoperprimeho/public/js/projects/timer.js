frappe.provide("shoperprimeho.timesheet");

shoperprimeho.timesheet.timer = function(frm, row, timestamp=0) {
	...
	shoperprimeho.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

shoperprimeho.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
