class CallPopup {
	...
	close_modal() {
		this.dialog.hide();
		delete shoperprimeho.call_popup;
	}
		...
		this.call_details = new frappe.ui.FieldGroup({
			fields: [{
				...
				'click': () => {
					...
					frappe.xcall('shoperprimeho.telephony.doctype.call_log.call_log.add_call_summary_and_call_type', {
