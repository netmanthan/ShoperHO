...
def task(doc_name, from_doctype, to_doctype):
	from shoperprimeho.accounts.doctype.payment_entry import payment_entry
	from shoperprimeho.accounts.doctype.purchase_invoice import purchase_invoice
	from shoperprimeho.accounts.doctype.sales_invoice import sales_invoice
	from shoperprimeho.buying.doctype.purchase_order import purchase_order
	from shoperprimeho.buying.doctype.supplier_quotation import supplier_quotation
	from shoperprimeho.selling.doctype.quotation import quotation
	from shoperprimeho.selling.doctype.sales_order import sales_order
	from shoperprimeho.stock.doctype.delivery_note import delivery_note
	from shoperprimeho.stock.doctype.purchase_receipt import purchase_receipt
