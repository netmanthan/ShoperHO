shoperprimeho.ProductView =  class {
	/* Options:
		- View Type
	...
	*/
	...
	prepare_toolbar() {
		...
		new shoperprimeho.ProductSearch();
	}
	...
	get_item_filter_data(from_filters=false) {
		...
		frappe.call({
			method: "shoperprimeho.e_commerce.api.get_product_filter_data",
			args: {
				query_args: args
			},
