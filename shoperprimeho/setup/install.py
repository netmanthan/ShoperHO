...
from shoperprimeho.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import DEFAULT_MAPPERS
from shoperprimeho.setup.default_energy_point_rules import get_default_energy_point_rules
from shoperprimeho.setup.doctype.incoterm.incoterm import create_incoterms

from .default_success_action import get_default_success_action

default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://shoperprimeho.org">ShoperPrimeHO</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """ShoperPrimeHO can only be installed on a fresh site where the setup wizard is not completed.
...
def add_standard_navbar_items():
	...
	for item in shoperprimeho_navbar_items:
...
def add_app_name():
	frappe.db.set_value("System Settings", None, "app_name", "ShoperPrimeHO")
