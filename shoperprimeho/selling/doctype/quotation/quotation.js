...
shoperprimeho.selling.QuotationController = class QuotationController extends shoperprimeho.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "shoperprimeho.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(shoperprimeho.selling.QuotationController);
