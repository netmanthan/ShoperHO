...
shoperprimeho.buying.SubcontractingOrderController = class SubcontractingOrderController {
	setup() {
	...
	make_subcontracting_receipt() {
		frappe.model.open_mapped_doc({
			method: 'shoperprimeho.subcontracting.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt',
			frm: cur_frm,
...
extend_cscript(cur_frm.cscript, new shoperprimeho.buying.SubcontractingOrderController({ frm: cur_frm }));
