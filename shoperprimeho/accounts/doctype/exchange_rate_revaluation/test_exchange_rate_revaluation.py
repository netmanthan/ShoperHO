...
from shoperprimeho import get_default_cost_center
from shoperprimeho.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from shoperprimeho.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
...
from shoperprimeho.accounts.test.accounts_mixin import AccountsTestMixin
...
class TestExchangeRateRevaluation(AccountsTestMixin, FrappeTestCase):
	...
	def test_04_get_account_details_function(self):
		...
		from shoperprimeho.accounts.doctype.exchange_rate_revaluation.exchange_rate_revaluation import (
			get_account_details,
		)
