...
shoperprimeho.selling.POSInvoiceController = class POSInvoiceController extends shoperprimeho.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new shoperprimeho.selling.POSInvoiceController({ frm: cur_frm }))
