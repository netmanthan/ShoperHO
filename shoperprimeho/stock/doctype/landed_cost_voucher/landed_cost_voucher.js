...
shoperprimeho.stock.LandedCostVoucher = class LandedCostVoucher extends shoperprimeho.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(shoperprimeho.stock.LandedCostVoucher);
