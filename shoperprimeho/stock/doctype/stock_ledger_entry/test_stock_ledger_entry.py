...
from shoperprimeho.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from shoperprimeho.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(FrappeTestCase, StockTestMixin):
	...
	def test_negative_qty_with_precision(self):
		...
		from shoperprimeho.stock.utils import get_stock_balance
...
def setup_item_valuation_test(
	...
	from shoperprimeho.stock.doctype.batch.batch import make_batch
	from shoperprimeho.stock.doctype.item.test_item import make_item
